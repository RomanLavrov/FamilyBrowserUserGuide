...
<div class="article-content" style="margin-bottom:-15px;">
      <div>
            ...
            <p>Um die Version der Familien innerhalb des Projekts zu aktualisieren, müssen Sie die Taste drücken
                  <img style="height:64px" src="/FamilyBrowser/images/FamiliesUpdateButton_de.PNG" />. Dadurch werden gesammelt
                  alle verwendeten Familien im Projekt und setzen sie in die Liste im Panel. Jede Familie, die von BUILDing360 gegründet wurde, wird
                  haben Vorschaubild, Beschreibung und Version. Sie können Familien nach Version filtern, indem Sie das Dropdown-Menü verwenden.
                  Filter.
            </p>
      ...
      <div class="row">
            ...
            <div class="col-md-6">
                  <p> Durch Drücken von "Change Version to V.V.V" - können Sie diese Familien in das aktuelle Projekt herunterladen.</p>
                  <p>Alle benutzerdefinierten Eigenschaften werden während des Aktualisierungsvorgangs automatisch übertragen..</p>
                  <p>Die Version für Familien kann aktualisiert und herabgestuft werden. Dazu gehen Sie zu Einstellungen, stellen Sie die bevorzugte Version ein und wählen Sie
                        Update wiederholen.</p>
                  <p>Version 0.9.0 hat keine Vorschaubilder..</p>
                  <p>Die Arten in den Familien können variieren. Wenn Sie die Version 1.0.0.0 verwendet haben und den Typ in der Version 2.0.0.0 nicht finden können - dann können Sie
                        müssen die Version 1.0.0.0 in den Einstellungen einstellen oder andere Elemente verwenden.</p>
            </div>
      </div>
</div>