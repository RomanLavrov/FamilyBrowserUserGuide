<div class="auth-card align-self-center">
    ...
    <div class="auth-card-body p-3">
        <form action="/FamilyBrowser/de/Auth/ResetPassword" method="post" class="d-flex flex-column align-items-stretch">
            <div class="input-group mt-3 mb-3 w-75 align-self-center">
                <input type="email" class="form-control" placeholder="Ihre E-Mail-Adresse angeben" name="mail">
            </div>               

            <button type="submit" class="btn btn-success w-75 align-self-center">Passwort zurücksetzen</button>
