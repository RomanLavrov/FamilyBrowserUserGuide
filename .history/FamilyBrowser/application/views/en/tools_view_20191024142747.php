...
<br/>
      ...
      <div style="font-weight:bold"class="col-md-1">
            ...
            <div class="col-md-6">
                  <p>OttoFischer web-service process 4 essential materials for walls regardless details. As architectural project can contains more than 4 essential types, please math up project materials with materials for export.</p>
                  <p>This procedure has to bo done once for the project and all selected pairs will be saved.</p>
            </div>
      </div>
      <br/>
      ...
      <div style="font-weight:bold"class="col-md-1">
            ...
            <div class="col-md-6">
                  ...
                  <p>Rooms and levels will be obtained from the attached architectural project. You can pick whole level or only several rooms from the building.</p>
            </div>
      </div>
      <br/>
      <div class="row">
      <div style="font-weight:bold"class="col-md-1">
            ...
            <div class="col-md-6">
                  <p>It is necessary to set Project Name before export. If project name wasn't specified before you can make it in this field. Project will be processed on OttoFisher web-service with this specified name.</p> 
                  <p>Rooms and levels will be obtained from the attached architectural project. You can pick whole level or only several rooms from the building.</p>
            </div>
      </div>
