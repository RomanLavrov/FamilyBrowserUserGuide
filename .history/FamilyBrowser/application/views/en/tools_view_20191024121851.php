...
<div class="article-content">
      ...
      <p>Location point tool will insert in this point special family - GDP in accordance with element rotation
            ...
            family type and if family was moved or rotated - please re-use this tool to move GDP points and remove unnecessary.
      </p>
</div>
...
<p>Tool has to be started in electrical project with devices and attached architectural project with walls and rooms. If there are multiple attached projects, please select one the that has necessary architectural data</p>
<p>This tool collects all electrical devices and equipment from project, wall, architectural room and level from attached architectural project and create data file for future processing in <a href="https://www.ottofischer.ch/">OttoFisher</a> web-service.</p>
