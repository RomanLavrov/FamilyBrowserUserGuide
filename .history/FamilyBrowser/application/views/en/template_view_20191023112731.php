    ...
    <div class="row" style="width:100%;   margin-left:0px">
        <div id="navigation" class="col-md-2">
            ...
            <div class='panel'>
                ...
                <a class="nav-button" target="_self" data-name="FAQ" href="/FamilyBrowser/en/">Settings</a>
                <a class="nav-button" target="_self" data-name="FAQ" href="/FamilyBrowser/en/FAQSettings">FAQ</a>
            </div>
