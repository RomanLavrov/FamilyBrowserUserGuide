    ...
    <div class="row" style="width:100%;   margin-left:0px">
        <div id="navigation" class="col-md-2">
            ...
            <div class='panel'>
                ...
                <a class="nav-button" target="_self" data-name="Settings" href="/FamilyBrowser/de/Settings">Settings</a>
            ...
            <button class="accordion">Familien einfügen</button>
            <div class="panel">
                <a class="nav-button" target="_self" data-name="Interface" href="/FamilyBrowser/de/Interface">Interface</a>
                <a class="nav-button" target="_self" data-name="Basic_functions" href="/FamilyBrowser/de/Basic_functions">Hauptfunktionen</a>               
            </div>
        </div>
