...
<div class="article-content">
      ...
      <div class="row">
            ...
            <div class="col-md-6">
                  <p>OttoFischer Webservice verarbeitet 4 wesentliche Materialien für Wände ohne Rücksicht auf Details. Als
                        Architekturprojekt kann mehr als 4 wesentliche Typen enthalten, bitte rechnen Sie Projektmaterialien zusammen.
                        mit Materialien für den Export.</p>
                  <p>Dieser Vorgang muss einmalig für das Projekt durchgeführt werden und alle ausgewählten Paare werden gespeichert.</p>
            </div>
      </div>
      <br />
      <div class="row">
            ...
            <div class="col-md-6">
                  ...
                  <p>Die Räume und Ebenen werden aus dem beigefügten Architekturprojekt bezogen. Du kannst die ganze Stufe wählen.
      ...
      <div class="row">
            ...
            <div class="col-md-6">
                  <p>Es ist notwendig, den Projektnamen vor dem Export festzulegen. Wenn der Projektname nicht angegeben wurde, bevor Sie die Möglichkeit haben.
                        es in diesem Bereich schaffen. Das Projekt wird auf dem OttoFisher Webservice mit diesem spezifizierten Namen bearbeitet.
                        Name.</p>
                  <p>Versionsinfo ist ein Benutzerfeld, das Informationen über Änderungen zwischen Projektversionen speichert.
                  </p>
