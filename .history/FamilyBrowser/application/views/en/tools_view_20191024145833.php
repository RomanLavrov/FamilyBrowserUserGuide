...
<div class="article-content">
      ...
      <div class="row">
            <div style="font-weight:bold" class="col-md-1">Result</div>
            <div class="col-md-5"><img  style="max-width:480px"src="/FamilyBrowser/images/OF_excelSample.png" alt=""></div>
            <div class="col-md-6"><p>All exported data will be saved in your Documents folder in excel format for visualisation and
                        checking.</p></div>
      </div>
