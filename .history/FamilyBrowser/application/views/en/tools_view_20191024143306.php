      ...
      <div class="row">
            ...
            <div class="col-md-6">
                  <p>It is necessary to set Project Name before export. If project name wasn't specified before you can
                        ...
                        name.</p>
                  <p>Version Info is a user field dedicated to store information about changes between project versions.</p>
                  <p>On Submit data will be send to the web-service. A PDF document with unique project code will be stored in your documents local folder and opened automatically after export ended. as well as excel file with </p>
