...
<div class="article-content">
      ...
      <div class="row">
            ...
            <div class="col-md-6">
                  ...
                  <p>On Submit data will be send to the web-service and a PDF document with unique project code will be stored in your documents local folder as well as excel file with </p>
            </div>
      </div>
